...
impl HandlerContext {
    ...
    pub async fn handle_list_all_panes(
        ...
        pane_tools::list_all_panes(self, session_filter).await
    }
    ...
    pub async fn handle_list_windows(
        ...
        window_tools::list_windows(self, session_filter).await
    }
    ...
    pub async fn handle_create_pane_with_options(
        ...
        pane_tools::create_pane_with_options(
            self,
            session_filter,
            window_filter,
            direction,
    ...
    pub async fn handle_create_session_with_options(
        ...
        session_tools::create_session_with_options(
            self,
            name,
            command,
            cwd,
    ...
    pub async fn handle_create_window_with_options(
        ...
        window_tools::create_window_with_options(
            self,
            session_filter,
            name,
            command,
    ...
    pub async fn handle_resize_pane_delta(
        ...
        pane_tools::resize_pane_delta(self, pane_id, delta).await
    }
    ...
    pub async fn handle_create_layout(
        ...
        layout_tools::create_layout(self, session_filter, window_filter, layout).await
    }
    ...
    pub async fn handle_set_environment(
        ...
        session_tools::set_environment(self, session_filter, key, value).await
    }
    ...
    pub async fn handle_get_environment(
        ...
        session_tools::get_environment(self, session_filter, key).await
    }
    ...
    pub async fn handle_set_metadata(
        ...
        session_tools::set_metadata(self, session_filter, key, value).await
    }
    ...
    pub async fn handle_get_metadata(
        ...
        session_tools::get_metadata(self, session_filter, key).await
    }
    ...
    pub async fn handle_set_tags(
        ...
        session_tools::set_tags(self, session_filter, add, remove).await
    }
    ...
    pub async fn handle_get_tags(
        ...
        session_tools::get_tags(self, session_filter).await
    }
}
