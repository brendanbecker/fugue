...
//!
//! Provides the `ccmux_run_parallel` tool for executing multiple commands
//! in parallel across separate panes and returning aggregated results.
...
fn parse_exit_marker(line: &str) -> Option<i32> {
